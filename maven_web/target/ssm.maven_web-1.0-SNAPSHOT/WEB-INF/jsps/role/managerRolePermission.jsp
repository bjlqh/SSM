...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h4 style="color: red">角色名称: ${role.roleName}</h4>
			<ol class="breadcrumb">
			...
			<form action="${pageContext.request.contextPath}/role/addPermissionToRole" method="post">
				...
				<section class="content">
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${pList}" var="permission">
									<tr>
										<td><input name="ids" type="checkbox" <c:if test="${fn:contains(pStr, permission.permissionName)}">checked</c:if> value="${permission.id}"></td>
										<td>${permission.id}</td>
